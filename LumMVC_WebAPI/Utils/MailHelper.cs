...
namespace LumMVC_WebAPI.Utils
{
    public class MailHelper
    {
        ...
        public static bool SendMail(string MailFrom, string[] MailTos, string MailSub, string MailBody, bool isBodyHtml, string[] filePaths, bool deleteFileAttachment)
        {
            try
            {
                //防呆
                ...
                {//※有些公司的Mail Server會規定寄信人的Domain Name要是該Mail Server的Domain Name
                    MailFrom = "LumMvcAdmin@lumentum.com";
                }
